        ...
        <div class="content">
          ...
          <div class="card" vertical>
            ...
            <div class="code" :class="{ visible : visible1 }">
              ...
              <div class="js">
                <textarea type="text" :value="js1" id="js1"></textarea>
                <a @click="copy($event, 'js1')">Copy</a>
                <pre>
                  {{ js1 }}
                </pre>
              </div>
          ...
          <div class="card" vertical>
            ...
            <div class="code" :class="{ visible : visible2 }">
              ...
              <div class="js">
                <textarea type="text" :value="js2" id="js2"></textarea>
                <a @click="copy($event, 'js2')">Copy</a>
                <pre>
                  {{ js2 }}
                </pre>
              </div>
          ...
          <div class="card" vertical>
            ...
            <div class="code" :class="{ visible : visible3 }">
              ...
              <div class="js">
                <textarea type="text" :value="js3" id="js3"></textarea>
                <a @click="copy($event, 'js3')">Copy</a>
                <pre>
                  {{ js3 }}
                </pre>
              </div>
          ...
          <div class="card" vertical>
            ...
            <div class="code" :class="{ visible : visible4 }">
              ...
              <div class="js">
                <textarea type="text" :value="js4" id="js4"></textarea>
                <a @click="copy($event, 'js4')">Copy</a>
                <pre>
                  {{ js4 }}
                </pre>
              </div>
    ...
    data () {
      return {
        ...
        html4: `<div class="leo-table">
                    <div class="leo-table-head" :style="{ 'min-width': (minWidth + 34) + 'px' }">
                      <table>
                        <colgroup>
                          <col width="34">
                          <col v-for="column in columns" :width="column['width']">
                    ...
                    <div class="leo-table-body" :style="{ 'min-width': (minWidth + 34) + 'px' }">
                      <table>
                        <colgroup>
                          <col width="34">
                          <col v-for="column in columns" :width="column['width']">
